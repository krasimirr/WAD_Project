...
// checks if the query contains only latin letters
function latinChecker() {
	var foreignCharacters = $("#searcher").val();
	var rforeign = /[^\u0000-\u007f]/;
	if (rforeign.test(foreignCharacters)) { alert("Please use only latin letters."); return false;}
	
	// "Loading gif"
	else {document.getElementById('loading').innerHTML = '<img src="/static/images/loading.gif" alt="Loading" height="20%" width="20%">'; return true;}
}
...
function change_password() {
	...
	$.ajax({
        ...
        success: function(){
			alert("You changed your password successfully! You will have to log in again.");
